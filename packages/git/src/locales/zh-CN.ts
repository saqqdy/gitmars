export default {
	...
	'Please set git access token': '请设置Git访问令牌',
	'Please set git miniprogram token': '请设置Git小程序令牌',
	'Please set git miniprogram session': '请设置Git小程序会话',
	...
	'Merge branch succeeded': '合并分支成功',
	'Merge branch failed': '合并分支失败',
	'Working on rebase branch': '正在变基分支',
	'Rebase branch succeeded': '变基分支成功',
	'Rebase branch failed': '变基分支失败',
	'Undoing code': '正在回撤代码',
