 ...
 * @returns command
 */
export declare async function acceptMergeRequest({ iid }: { iid: number | string }) {
	const params = {
		private_token: token
	}
 ...
 * @returns command
 */
export declare async function createMergeRequest({
	source_branch,
	target_branch,
	description
}: {
 ...
 * @returns command
 */
export declare async function deleteMergeRequest({ iid }: { iid: number | string }) {
	const params = {
		private_token: token
	}
 ...
 * @returns command
 */
export declare async function getMergeRequestChanges({ iid }: { iid: number | string }) {
	const params = {
		private_token: token
	}
 ...
 * @returns command
 */
export declare async function getMergeRequestCloseIssues({ iid }: { iid: number | string }) {
	const params = {
		private_token: token
	}
	const fetchData = await request.get({
 ...
 * @returns command
 */
export declare async function getMergeRequestCommits({ iid }: { iid: number | string }) {
	const params = {
		private_token: token
	}
	const fetchData = await request.get({
 ...
 * @returns command
 */
export declare async function getMergeRequestDiffVersions({ iid }: { iid: number | string }) {
	const params = {
		private_token: token
	}
	const fetchData = await request.get({
 ...
 * @returns command
 */
export declare async function getMergeRequestList({
	state = 'opened'
}: {
 ...
 * @returns command
 */
export declare async function getMergeRequestParticipants({ iid }: { iid: number | string }) {
	const params = {
		private_token: token
	}
	const fetchData = await request.get({
 ...
 * @returns command
 */
export declare async function updateMergeRequest({
	iid,
	data = {}
}: {
	iid: number | string
