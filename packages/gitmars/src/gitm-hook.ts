...
const getBranchesFromID = require('@gitmars/core/es/git/getBranchesFromID')
...
const getIsMergedTargetBranch = require('@gitmars/core/es/git/getIsMergedTargetBranch')
const getIsUpdatedInTime = require('@gitmars/core/es/git/getIsUpdatedInTime')
const getIsMergeAction = require('@gitmars/core/es/git/getIsMergeAction')
const getBehindLogs = require('@gitmars/core/es/git/getBehindLogs')
const { createArgs } = require('@gitmars/core/es/utils/command')
const { init, remove } = require('@gitmars/core/es/hook/index')
if (!getIsGitProject()) {
