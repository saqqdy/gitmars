...
const getBranchesFromID = require('@gitmars/core/git/getBranchesFromID')
...
const getIsMergedTargetBranch = require('@gitmars/core/git/getIsMergedTargetBranch')
const getIsUpdatedInTime = require('@gitmars/core/git/getIsUpdatedInTime')
const getIsMergeAction = require('@gitmars/core/git/getIsMergeAction')
const getBehindLogs = require('@gitmars/core/git/getBehindLogs')
const { createArgs } = require('@gitmars/core/utils/command')
const { init, remove } = require('@gitmars/core/hook/index')
if (!getIsGitProject()) {
