...
const getGitConfig = require('@gitmars/core/es/git/getGitConfig')
const getIsMergedTargetBranch = require('@gitmars/core/es/git/getIsMergedTargetBranch')
const getIsBranchOrCommitExist = require('@gitmars/core/es/git/getIsBranchOrCommitExist')
...
const getUserToken = require('@gitmars/core/es/api/getUserToken')
