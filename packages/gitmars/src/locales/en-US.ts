export default {
	...
	'Release bugfix, release, support branches': 'Release bugfix, release, support branches',
	'Update bugfix, release, support branch code': 'Update bugfix, release, support branch code',
	...
	'Delete branch before fixed duration, fill in format: 10s/2m/2h/3d/4M/5y':
		'Delete branch before fixed duration, fill in format: 10s/2m/2h/3d/4M/5y',
	'Whether to sync to alpha test environment': 'Whether to sync to alpha test environment',
	'Whether to sync to pre-release environment': 'Whether to sync to pre-release environment',
	...
	'Whether to restrict release commits': 'Whether to restrict release commits',
	'No recoverable undo logs found, process exited':
		'No recoverable undo logs found, process exited',
	'No logs selected, process has exited': 'No logs selected, process has exited',
	Close: 'Close',
	Deleted: 'Deleted',
	Submitted: 'Submitted',
	...
	'The {target} branch was created successfully and is based on {base}, you have now switched to {target}\nWhen you need to publish, remember to run: {command}':
		'The {target} branch was created successfully and is based on {base}, you have now switched to {target}\nWhen you need to publish, remember to run: {command}',
	'Merge {source} into {target} successfully': 'Merge {source} into {target} successfully',
	...
	"Hey {nickname}, you don't have permission": "Hey {nickname}, you don't have permission",
	'{source} has been merged with {target}': '{source} has been merged with {target}',
	'Merge {source} to {target} successfully': 'Merge {source} to {target} successfully',
	'An error occurred merging {source} to {target}, please follow the instructions':
		'An error occurred merging {source} to {target}, please follow the instructions',
