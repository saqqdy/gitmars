export default {
    ...
    'Set association with remote branches':
        'Set association with remote branches',
    ...
    'Execute commit, information required':
        'Execute commit, information required',
    ...
    'Copy the source branch of the record':
        'Copy the source branch of the record',
    ...
    'Whether to output logs in json format, default form':
        'Whether to output logs in json format, default form',
    'The api address of the push message':
        'The api address of the push message',
    ...
    '--calc and --calcAll can only be used individually':
        '--calc and --calcAll can only be used individually',
    'Use merge to update (default merge)':
        'Use merge to update (default merge)',
    ...
    'There is a conflict or merge is not required':
        'There is a conflict or merge is not required',
    ...
    'No branches were selected and the process has exited.':
        'No branches were selected and the process has exited.',
    'Analysis complete, no branches to clean up':
        'Analysis complete, no branches to clean up',
    'Deletion complete, these branches have been cleaned up':
        'Deletion complete, these branches have been cleaned up',
    'Please enter the message to be submitted':
        'Please enter the message to be submitted',
    'Please enter the environment to sync to.':
        'Please enter the environment to sync to.',
    ...
    'This branch has not been synced for more than 1 week, please sync it at least once a week, execute: gitm update':
        'This branch has not been synced for more than 1 week, please sync it at least once a week, execute: gitm update',
    'Please enter the items to be configured':
        'Please enter the items to be configured',
    ...
    'An uncommitted file was detected, please be aware!':
        'An uncommitted file was detected, please be aware!',
    'There are no unexecuted commands in the queue':
        'There are no unexecuted commands in the queue',
    ...
    'Merge bugfix task branch, merge feature function development branch, the corresponding branch will be deleted after the merge is completed':
        'Merge bugfix task branch, merge feature function development branch, the corresponding branch will be deleted after the merge is completed',
    'There are no files staged in this branch!':
        'There are no files staged in this branch!',
    'File recovery successful': 'File recovery successful',
    'Recovery failed, please check for conflicts':
        'Recovery failed, please check for conflicts',
    ...
    'The local version is not behind the remote, you can push it directly':
        'The local version is not behind the remote, you can push it directly',
    'Set configuration items for gitmars':
        'Set configuration items for gitmars',
    ...
    'Please enter the message push address':
        'Please enter the message push address',
    ...
    'Installing plugins, e.g. @gitmars/ui':
        'Installing plugins, e.g. @gitmars/ui',
    ...
    'Please select the undo record to restore':
        'Please select the undo record to restore',
    'Please select the merge request to be operated':
        'Please select the merge request to be operated',
    ...
    'Create bugfix task branch, create feature development branch, support framework support branch':
        'Create bugfix task branch, create feature development branch, support framework support branch',
    'Branch name does not conform to specification':
        'Branch name does not conform to specification',
    ...
    'No commit record selected, process has exited':
        'No commit record selected, process has exited',
    'Please select the commit record to undo.':
        'Please select the commit record to undo.',
    ...
    'View/Set configuration items for gitmars':
        'View/Set configuration items for gitmars',
    ...
    "Simplify git's cherry-pick operation":
        "Simplify git's cherry-pick operation",
    ...
    'Withdraw commits on master branches':
        'Withdraw commits on master branches',
    ...
    'Create bugfix, release, develop and support branches':
        'Create bugfix, release, develop and support branches',
    'The {branch} branch already exists and does not need to be created again':
        'The {branch} branch already exists and does not need to be created again',
    'type only allows input': 'type only allows input',
    'Release bugfix, release, support branches':
        'Release bugfix, release, support branches',
    'Update bugfix, release, support branch code':
        'Update bugfix, release, support branch code',
    'Build cleanup job': 'Build cleanup job',
    'Approve merge request': 'Approve merge request',
    'Please select the following action': 'Please select the following action',
    'New path': 'New path',
    ...
    exited: 'exited',
    'Delete branch before fixed duration, fill in format: 10s/2m/2h/3d/4M/5y':
        'Delete branch before fixed duration, fill in format: 10s/2m/2h/3d/4M/5y',
    'Whether to sync to alpha test environment':
        'Whether to sync to alpha test environment',
    'Whether to sync to pre-release environment':
        'Whether to sync to pre-release environment',
    ...
    "Whether to exclude merge's log": "Whether to exclude merge's log",
    'Whether to restrict dev commits': 'Whether to restrict dev commits',
    'Whether to restrict release commits':
        'Whether to restrict release commits',
    'No recoverable undo logs found, process exited':
        'No recoverable undo logs found, process exited',
    'No logs selected, process has exited':
        'No logs selected, process has exited',
    Close: 'Close',
    Deleted: 'Deleted',
    Submitted: 'Submitted',
    ...
    'Path of package': 'Path of package',
    ...
    '{app} item {source} merged to {target} request ID {id} has new comments: {note}':
        '{app} item {source} merged to {target} request ID {id} has new comments: {note}',
    'Merge request {id}: Merged': 'Merge request {id}: Merged',
    'Merge request {id}: Deleted': 'Merge request {id}: Deleted',
    'Merge request {id}: Closed': 'Merge request {id}: Closed',
    "Hey {nickname}, you don't have permission":
        "Hey {nickname}, you don't have permission",
    ...
    'Cannot be deleted: {something}': 'Cannot be deleted: {something}',
    'Analysis completed: {something}': 'Analysis completed: {something}',
    'Undo successfully: {something}': 'Undo successfully: {something}',
    ...
    'Please enter the available comments':
        'Please enter the available comments',
