...
# 2020.07.22 v1.3.0更新日志
1. 新增link指令，用来创建本地包软链接
...
# 2020.06.30 v1.2.7更新日志
1. 升级combine/end/update指令，分支名称可以不传，默认合并/结束/更新当前分支
2. combine指令新增-a和-m参数，传入可自动执行add和commit
2. 文档升级
