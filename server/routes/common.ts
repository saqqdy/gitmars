...
// 获取项目列表
router.get('/project/list', (req: Request, res: Response, next: NextFunction) => {
	let list = []
	if (req.query.id) {
...
// 删除项目
router.post('/project/del', (req: Request, res: Response, next: NextFunction) => {
...
// 更新项目
router.post('/project/update', (req: Request, res: Response, next: NextFunction) => {
	if (!req.body.id) error503(res)
...
// 检测项目
router.get('/project/check', (req: Request, res: Response, next: NextFunction) => {
