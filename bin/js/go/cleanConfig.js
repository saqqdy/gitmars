 ...
 * @param {object} cleaner 清理设置
 * @param {array} cleaner.delOptions 删除option
 * @param {array} cleaner.requiredOptions 必填option
 * @param {array} cleaner.delArgs 删除参数
 * @param {array} cleaner.requiredArgs 必填参数
