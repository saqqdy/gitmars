import{_ as i,o as a,c as n,ag as l}from"./chunks/framework.BiCIjUVY.js";const F=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"zh/guide/getting-start.md","filePath":"zh/guide/getting-start.md"}'),t={name:"zh/guide/getting-start.md"};function p(h,s,e,k,r,d){return a(),n("div",null,s[0]||(s[0]=[l(`<h2 id="安装" tabindex="-1">安装 <a class="header-anchor" href="#安装" aria-label="Permalink to &quot;安装&quot;">​</a></h2><blockquote><p>Windows 用户需要安装 Python 环境</p></blockquote><div class="language-shell vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">shell</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 通过npm安装</span></span>
