...
program.name("gitm approve").usage("[--state [state]] [--postmsg]").description("\u5BA1\u6279\u8FDC\u7A0B\u5408\u5E76\u8BF7\u6C42");
if (args.length > 0)
...
program.action(async (opt) => {
  ...
  iids.forEach(async (iid) => {
    ...
    if (accept === "\u901A\u8FC7") {
      ...
      opt.postmsg && sendGroupMessage(`${appName}\u9879\u76EE${source_branch}\u5408\u5E76\u5230${target_branch}\u8BF7\u6C42ID${iid}\u5DF2\u5408\u5E76`);
...
${iid}\uFF1A\u4E00\u5171\u53D8\u52A8\u4E86${changes_count}\u4E2A\u6587\u4EF6`));
      ...
      opt.postmsg && sendGroupMessage(`${appName}\u9879\u76EE${source_branch}\u5408\u5E76\u5230${target_branch}\u8BF7\u6C42ID${iid}\u5DF2\u5220\u9664`);
      ...
      opt.postmsg && sendGroupMessage(`${appName}\u9879\u76EE${source_branch}\u5408\u5E76\u5230${target_branch}\u8BF7\u6C42ID${iid}\u5DF2\u6682\u65F6\u5173\u95ED`);
