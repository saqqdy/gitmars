...
program.action(async (opt) => {
  ...
  iids.forEach(async (iid) => {
    const mr = mrList.find((item) => item.iid === iid);
...
${iid}\uFF1A\u4E00\u5171\u53D8\u52A8\u4E86${changes_count}\u4E2A\u6587\u4EF6`));
      ...
      opt.postmsg && postMessage(`\u4EE3\u7801\u5199\u7684\u5F88\u68D2\u4E86\uFF0C\u53EF\u4EE5\u7A0D\u5FAE\u518D\u4F18\u5316\u4E00\u4E0B\uFF0C${appName}\u9879\u76EE\u5408\u5E76\u8BF7\u6C42${iid}\u5DF2\u5220\u9664`);
      ...
      opt.postmsg && postMessage(`\u4EE3\u7801\u5199\u7684\u5F88\u68D2\u4E86\uFF0C\u53EF\u4EE5\u7A0D\u5FAE\u518D\u4F18\u5316\u4E00\u4E0B\uFF0C${appName}\u9879\u76EE\u5408\u5E76\u8BF7\u6C42${iid}\u5DF2\u6682\u65F6\u5173\u95ED`);
