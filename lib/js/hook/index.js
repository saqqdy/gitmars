...
function getAheadLogs() {
  ...
  const result = sh__default['default'].exec(`git log origin/${current}..${current} --pretty=format:"%p"`, {
    silent: true
  }).stdout.replace(/[\s]*$/g, '');
  return result ? result.split('\n') : [];
}
function init() {
  ...
  if (ciInfo__default['default'].isCI && config.skipCI) {
...
exports.createHookShell = createHookShell;
exports.createHooks = createHooks;
exports.createLocalShell = createLocalShell;
exports['default'] = index;
exports.getAheadLogs = getAheadLogs;
exports.getBehandLogs = getBehandLogs;
exports.getIsMergeAction = getIsMergeAction;
exports.getIsMergedBranch = getIsMergedBranch;
exports.getIsUpdatedInTime = getIsUpdatedInTime;
exports.init = init;
exports.remove = remove;
exports.removeHookShell = removeHookShell;
exports.removeHooks = removeHooks;
exports.removeLocalShell = removeLocalShell;
