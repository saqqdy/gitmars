...
var searchBranch = function () {
  var _ref4 = _asyncToGenerator(regeneratorRuntime.mark(function _callee4(key, type) {
    var remote,
        data,
        arr,
        _args4 = arguments;
    return regeneratorRuntime.wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            remote = _args4.length > 2 && _args4[2] !== undefined ? _args4[2] : false;
            _context4.next = 3;
...
var getStashList = function () {
  var _ref5 = _asyncToGenerator(regeneratorRuntime.mark(function _callee5(key) {
    var data, list, arr;
    return regeneratorRuntime.wrap(function _callee5$(_context5) {
      while (1) {
        switch (_context5.prev = _context5.next) {
          ...
          case 2:
            data = _context5.sent[0].out.replace(/^\*\s+/, '');
