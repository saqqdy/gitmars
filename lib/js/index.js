...
var getStatus = function getStatus() {
  var out = sh.exec('git status -s --no-column', {
    silent: false
  }).stdout.replace(/(^\s+|\n*$)/g, '');
  var list = out ? out.replace(/\n(\s+)/g, '\n').split('\n') : [],
      sum = {
    A: [],
    D: [],
    M: [],
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 2:
            data = _context.sent;
            return _context.abrupt("return", data[0].out.replace(/^\s+/, ''));
...
var getCurrent = function getCurrent() {
  return sh.exec('git symbolic-ref --short -q HEAD', {
    silent: true
  }).stdout.replace(/[\n\s]*$/g, '');
};

var searchBranch = function () {
  var _ref2 = _asyncToGenerator(regeneratorRuntime.mark(function _callee2(key, type) {
    var remote,
        data,
        arr,
        _args2 = arguments;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            remote = _args2.length > 2 && _args2[2] !== undefined ? _args2[2] : false;
            _context2.next = 3;
            return queue(["gitm branch".concat(key ? ' -k ' + key : '').concat(type ? ' -t ' + type : '').concat(remote ? ' -r' : '')]);

          case 3:
            data = _context2.sent[0].out.replace(/^\*\s+/, '');
            arr = data ? data.split('\n') : [];
...
var getStashList = function () {
    ...
    return regeneratorRuntime.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 2:
            data = _context3.sent[0].out.replace(/^\*\s+/, '');
  ...
  return function getStashList(_x4) {
