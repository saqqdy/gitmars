	...
	},
	{
		...
		children: [
			...
			},
			{
				path: 'add',
				name: 'project_add',
				component: () => import(/* webpackChunkName: "project" */ '../views/project/add.vue')
			}
		]
	},
	{
		...
		children: [
			{
				...
				component: () => import(/* webpackChunkName: "control" */ '../views/control/gitmars.vue')
			},
			{
				path: 'tasks',
				name: 'control_tasks',
				component: () => import(/* webpackChunkName: "control" */ '../views/control/tasks.vue')
			}
		]
	}
]
